 ...
 */
#ifndef RTW_HEADER_cart_count2_h_
#define RTW_HEADER_cart_count2_h_
#ifndef cart_count2_COMMON_INCLUDES_
# define cart_count2_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* cart_count2_COMMON_INCLUDES_ */

#include "cart_count2_types.h"
...
struct P_cart_count2_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Gain_Gain;                    /* Expression: 0.8/35277.75
...
extern P_cart_count2_T cart_count2_P;

/* Block signals (auto storage) */
extern B_cart_count2_T cart_count2_B;

/* Block states (auto storage) */
extern DW_cart_count2_T cart_count2_DW;

/* Model entry point functions */
extern void cart_count2_initialize(void);
extern void cart_count2_step(void);
extern void cart_count2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_cart_count2_T *const cart_count2_M;
 ...
 * '<Root>' : 'cart_count2'
 */
#endif                                 /* RTW_HEADER_cart_count2_h_ */
