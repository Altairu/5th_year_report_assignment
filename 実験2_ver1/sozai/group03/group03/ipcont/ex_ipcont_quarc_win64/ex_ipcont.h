 ...
 */
#ifndef RTW_HEADER_ex_ipcont_h_
#define RTW_HEADER_ex_ipcont_h_
#ifndef ex_ipcont_COMMON_INCLUDES_
# define ex_ipcont_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_ipcont_COMMON_INCLUDES_ */

#include "ex_ipcont_types.h"
...
struct P_ex_ipcont_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain_c;                 /* Expression: kI
...
extern P_ex_ipcont_T ex_ipcont_P;

/* Block signals (auto storage) */
extern B_ex_ipcont_T ex_ipcont_B;

/* Continuous states (auto storage) */
extern X_ex_ipcont_T ex_ipcont_X;

/* Block states (auto storage) */
extern DW_ex_ipcont_T ex_ipcont_DW;

/* Model entry point functions */
extern void ex_ipcont_initialize(void);
extern void ex_ipcont_step(void);
extern void ex_ipcont_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ex_ipcont_T *const ex_ipcont_M;
 ...
 *
 * '<Root>' : 'ex_ipcont'
 * '<S1>'   : 'ex_ipcont/Subsystem (I-P Controller)'
 * '<S2>'   : 'ex_ipcont/Subsystem (Robot)'
 */
#endif                                 /* RTW_HEADER_ex_ipcont_h_ */
