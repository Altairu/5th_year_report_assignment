 ...
 */
#ifndef RTW_HEADER_pend_count3_h_
#define RTW_HEADER_pend_count3_h_
#ifndef pend_count3_COMMON_INCLUDES_
# define pend_count3_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* pend_count3_COMMON_INCLUDES_ */

#include "pend_count3_types.h"
...
typedef struct {
  ...
  real_T Gainradtodeg;                 /* '<Root>/Gain (rad to deg)' */
} B_pend_count3_T;
...
struct P_pend_count3_T_ {
  ...
  real_T Switch_Threshold;             /* Expression: 0
                                        ...
                                        */
  real_T Gainradtodeg_Gain;            /* Expression: 180/pi
...
extern P_pend_count3_T pend_count3_P;

/* Block signals (auto storage) */
extern B_pend_count3_T pend_count3_B;

/* Block states (auto storage) */
extern DW_pend_count3_T pend_count3_DW;

/* Model entry point functions */
extern void pend_count3_initialize(void);
extern void pend_count3_step(void);
extern void pend_count3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_pend_count3_T *const pend_count3_M;
 ...
 * '<Root>' : 'pend_count3'
 */
#endif                                 /* RTW_HEADER_pend_count3_h_ */
