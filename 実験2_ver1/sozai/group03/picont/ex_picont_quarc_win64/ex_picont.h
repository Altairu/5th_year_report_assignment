 ...
 */
#ifndef RTW_HEADER_ex_picont_h_
#define RTW_HEADER_ex_picont_h_
#ifndef ex_picont_COMMON_INCLUDES_
# define ex_picont_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_picont_COMMON_INCLUDES_ */

#include "ex_picont_types.h"
...
struct P_ex_picont_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain_p;                 /* Expression: kI
...
extern P_ex_picont_T ex_picont_P;

/* Block signals (auto storage) */
extern B_ex_picont_T ex_picont_B;

/* Continuous states (auto storage) */
extern X_ex_picont_T ex_picont_X;

/* Block states (auto storage) */
extern DW_ex_picont_T ex_picont_DW;

/* Model entry point functions */
extern void ex_picont_initialize(void);
extern void ex_picont_step(void);
extern void ex_picont_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ex_picont_T *const ex_picont_M;
 ...
 *
 * '<Root>' : 'ex_picont'
 * '<S1>'   : 'ex_picont/Subsystem'
 * '<S2>'   : 'ex_picont/Subsystem1'
 */
#endif                                 /* RTW_HEADER_ex_picont_h_ */
