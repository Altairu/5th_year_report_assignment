 ...
 */
#ifndef RTW_HEADER_ex_ident_h_
#define RTW_HEADER_ex_ident_h_
#ifndef ex_ident_COMMON_INCLUDES_
# define ex_ident_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_ident_COMMON_INCLUDES_ */

#include "ex_ident_types.h"
...
extern P_ex_ident_T ex_ident_P;

/* Block signals (auto storage) */
extern B_ex_ident_T ex_ident_B;

/* Continuous states (auto storage) */
extern X_ex_ident_T ex_ident_X;

/* Block states (auto storage) */
extern DW_ex_ident_T ex_ident_DW;

/* Model entry point functions */
extern void ex_ident_initialize(void);
extern void ex_ident_step(void);
extern void ex_ident_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ex_ident_T *const ex_ident_M;
 ...
 *
 * '<Root>' : 'ex_ident'
 * '<S1>'   : 'ex_ident/Subsystem (Robot)'
 */
#endif                                 /* RTW_HEADER_ex_ident_h_ */
