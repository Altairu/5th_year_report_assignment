...
void da_conv_step(void)
{
   ...
   *  Sin: '<Root>/Sine Wave'
   */
  if (da_conv_P.ManualSwitch_CurrentSetting == 1)
  {
    da_conv_B.ManualSwitch = da_conv_P.Constant_Value;
  }
  else
  {
    da_conv_B.ManualSwitch = sin(da_conv_P.SineWave_Freq * da_conv_M->Timing.t[0] + da_conv_P.SineWave_Phase) * da_conv_P.SineWave_Amp +
                             da_conv_P.SineWave_Bias;
  }
  ...
  /* S-Function Block: da_conv/HIL Write Analog (hil_write_analog_block) */
  {
    ...
    result = hil_write_analog(da_conv_DW.HILInitialize_Card,
                              &da_conv_P.HILWriteAnalog_Channels, 1, &da_conv_B.ManualSwitch);
    if (result < 0)
    {
  ...
  { /* Sample time: [0.0s, 0.0s] */
    rtExtModeUpload(0, da_conv_M->Timing.t[0]);
  }

  { /* Sample time: [0.001s, 0.0s] */
    rtExtModeUpload(1, (((da_conv_M->Timing.clockTick1 +
                          da_conv_M->Timing.clockTickH1 * 4294967296.0)) *
                        0.001));
  }
  ...
  { /* Sample time: [0.0s, 0.0s] */
    if ((rtmGetTFinal(da_conv_M) != -1) &&
        !((rtmGetTFinal(da_conv_M) - da_conv_M->Timing.t[0]) > da_conv_M->Timing.t[0] * (DBL_EPSILON)))
    {
  ...
  da_conv_M->Timing.t[0] = da_conv_M->Timing.clockTick0 *
                               da_conv_M->Timing.stepSize0 +
                           da_conv_M->Timing.clockTickH0 *
...

  {
     ...
     */
    da_conv_M->Timing.clockTick1++;
    if (!da_conv_M->Timing.clockTick1)
    {
      da_conv_M->Timing.clockTickH1++;
    }
  }
}
...
void da_conv_initialize(void)
{
  ...
  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&da_conv_M->solverInfo, &da_conv_M->Timing.simTimeStep);
    rtsiSetTPtr(&da_conv_M->solverInfo, &rtmGetTPtr(da_conv_M));
    rtsiSetStepSizePtr(&da_conv_M->solverInfo, &da_conv_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&da_conv_M->solverInfo, (&rtmGetErrorStatus(da_conv_M)));
    rtsiSetRTModelPtr(&da_conv_M->solverInfo, da_conv_M);
  }

  rtsiSetSimTimeStep(&da_conv_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetSolverName(&da_conv_M->solverInfo, "FixedStepDiscrete");
  rtmSetTPtr(da_conv_M, &da_conv_M->Timing.tArray[0]);
  rtmSetTFinal(da_conv_M, -1);
  da_conv_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  da_conv_M->Sizes.checksums[0] = (2915857561U);
  da_conv_M->Sizes.checksums[1] = (2176412797U);
  da_conv_M->Sizes.checksums[2] = (3876236399U);
  da_conv_M->Sizes.checksums[3] = (1206592115U);
  ...
  /* S-Function Block: da_conv/HIL Initialize (hil_initialize_block) */
  {
    ...
    if (da_conv_P.HILInitialize_AOReset)
    {
      ...
      result = hil_watchdog_set_analog_expiration_state(da_conv_DW.HILInitialize_Card, da_conv_P.HILInitialize_AOChannels, 8U,
                                                        &da_conv_DW.HILInitialize_AOVoltages[0]);
      if (result < 0)
      {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof(_rt_error_message));
        ...
        (da_conv_P.HILInitialize_EIPEnter && is_switching))
    {
      ...
      result = hil_set_encoder_quadrature_mode(da_conv_DW.HILInitialize_Card,
                                               da_conv_P.HILInitialize_EIChannels, 8U, (t_encoder_quadrature_mode *)&da_conv_DW.HILInitialize_QuadratureModes[0]);
      if (result < 0)
      {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof(_rt_error_message));
        rtmSetErrorStatus(da_conv_M, _rt_error_message);
        ...
        (da_conv_P.HILInitialize_POPEnter && is_switching))
    {
      ...
      result = hil_set_pwm_mode(da_conv_DW.HILInitialize_Card,
                                da_conv_P.HILInitialize_POChannels, 8U, (t_pwm_mode *)&da_conv_DW.HILInitialize_POModeValues[0]);
      if (result < 0)
      {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof(_rt_error_message));
        rtmSetErrorStatus(da_conv_M, _rt_error_message);
    ...
    if (da_conv_P.HILInitialize_POReset)
    {
      ...
      result = hil_watchdog_set_pwm_expiration_state(da_conv_DW.HILInitialize_Card, da_conv_P.HILInitialize_POChannels, 8U,
                                                     &da_conv_DW.HILInitialize_POValues[0]);
      if (result < 0)
      {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof(_rt_error_message));
...
void da_conv_terminate(void)
{
  ...
  /* S-Function Block: da_conv/HIL Initialize (hil_initialize_block) */
  {
    ...
    if (0 || num_final_analog_outputs > 0 || num_final_pwm_outputs > 0)
    {
      ...
      result = hil_write(da_conv_DW.HILInitialize_Card, da_conv_P.HILInitialize_AOChannels,
                         num_final_analog_outputs, da_conv_P.HILInitialize_POChannels,
                         num_final_pwm_outputs, NULL, 0, NULL, 0, &da_conv_DW.HILInitialize_AOVoltages[0], &da_conv_DW.HILInitialize_POValues[0], (t_boolean *)NULL, NULL);
    ...
    elete_all(da_conv_DW.HILInitialize_Card);
