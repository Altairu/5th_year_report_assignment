 ...
 */
#ifndef RTW_HEADER_ex_pdcont_h_
#define RTW_HEADER_ex_pdcont_h_
#ifndef ex_pdcont_COMMON_INCLUDES_
# define ex_pdcont_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_pdcont_COMMON_INCLUDES_ */

#include "ex_pdcont_types.h"
...
extern P_ex_pdcont_T ex_pdcont_P;

/* Block signals (auto storage) */
extern B_ex_pdcont_T ex_pdcont_B;

/* Continuous states (auto storage) */
extern X_ex_pdcont_T ex_pdcont_X;

/* Block states (auto storage) */
extern DW_ex_pdcont_T ex_pdcont_DW;

/* Model entry point functions */
extern void ex_pdcont_initialize(void);
extern void ex_pdcont_step(void);
extern void ex_pdcont_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ex_pdcont_T *const ex_pdcont_M;
 ...
 *
 * '<Root>' : 'ex_pdcont'
 * '<S1>'   : 'ex_pdcont/Subsystem (P-D Controller)'
 * '<S2>'   : 'ex_pdcont/Subsystem (Robot)'
 */
#endif                                 /* RTW_HEADER_ex_pdcont_h_ */
