...
% ----------------------------------------------
figure(1); print -dpdf figure_pdcont_angle.pdf
figure(2); print -dpdf figure_pdcont_volt.pdf
figure(3); print -dpdf figure_pdcont_model.pdf

figure(1); print -dbitmap figure_pdcont_angle.bmp
figure(2); print -dbitmap figure_pdcont_volt.bmp
figure(3); print -dbitmap figure_pdcont_model.bmp
