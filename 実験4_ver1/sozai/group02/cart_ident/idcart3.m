...
% load cart_data     % kP = 50; zc = 0.2;
% load cart_data2      % kP = 100; zc = 0.1;
load cart_data3      % kP = 200; zc = 0.05;
...
print -dpdf    figure_idcart3.pdf
print -dbitmap figure_idcart3.bmp

figure(2)
set(gcf,'PaperPositionMode','auto')
print -dpdf    figure_idcart3_u.pdf
print -dbitmap figure_idcart3_u.bmp
