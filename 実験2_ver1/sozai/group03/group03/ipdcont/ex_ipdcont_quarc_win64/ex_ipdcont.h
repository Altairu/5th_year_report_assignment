 ...
 */
#ifndef RTW_HEADER_ex_ipdcont_h_
#define RTW_HEADER_ex_ipdcont_h_
#ifndef ex_ipdcont_COMMON_INCLUDES_
# define ex_ipdcont_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_ipdcont_COMMON_INCLUDES_ */

#include "ex_ipdcont_types.h"
...
struct P_ex_ipdcont_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Gain1_Gain;                   /* Expression: -0.6155
                                        * Referenced by: '<S2>/Gain1'
                                        */
  real_T Integrator_IC;                /* Expression: 0
                                        * Referenced by: '<S1>/Integrator'
                                        */
  real_T Gain2_Gain;                   /* Expression: kI
                                        * Referenced by: '<S1>/Gain2'
                                        */
  real_T Gain_Gain;                    /* Expression: kP
  ...
  real_T TransferFcn_D;                /* Computed Parameter: TransferFcn_D
                                        * Referenced by: '<S1>/Transfer Fcn'
                                        */
  real_T Gain1_Gain_p;                 /* Expression: kD
...
extern P_ex_ipdcont_T ex_ipdcont_P;

/* Block signals (auto storage) */
extern B_ex_ipdcont_T ex_ipdcont_B;

/* Continuous states (auto storage) */
extern X_ex_ipdcont_T ex_ipdcont_X;

/* Block states (auto storage) */
extern DW_ex_ipdcont_T ex_ipdcont_DW;

/* Model entry point functions */
extern void ex_ipdcont_initialize(void);
extern void ex_ipdcont_step(void);
extern void ex_ipdcont_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ex_ipdcont_T *const ex_ipdcont_M;
 ...
 *
 * '<Root>' : 'ex_ipdcont'
 * '<S1>'   : 'ex_ipdcont/Subsystem (I-PD Controller)'
 * '<S2>'   : 'ex_ipdcont/Subsystem (Robot)'
 */
#endif                                 /* RTW_HEADER_ex_ipdcont_h_ */
