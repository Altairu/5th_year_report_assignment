 ...
 */
#ifndef RTW_HEADER_da_conv_h_
#define RTW_HEADER_da_conv_h_
#ifndef da_conv_COMMON_INCLUDES_
# define da_conv_COMMON_INCLUDES_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* da_conv_COMMON_INCLUDES_ */

#include "da_conv_types.h"
...
struct P_da_conv_T_ {
  ...
  real_T Constant_Value;               /* Expression: 5
                                        ...
                                        */
  real_T SineWave_Amp;                 /* Expression: 15
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Bias;                /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Freq;                /* Expression: pi/0.008
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
...
extern P_da_conv_T da_conv_P;

/* Block signals (auto storage) */
extern B_da_conv_T da_conv_B;

/* Block states (auto storage) */
extern DW_da_conv_T da_conv_DW;

/* Model entry point functions */
extern void da_conv_initialize(void);
extern void da_conv_step(void);
extern void da_conv_terminate(void);

/* Real-time Model object */
extern RT_MODEL_da_conv_T *const da_conv_M;
