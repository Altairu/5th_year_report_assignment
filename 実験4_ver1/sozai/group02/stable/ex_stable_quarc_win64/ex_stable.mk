...
MODEL                = ex_stable
MODULES              = ex_stable_data.c ex_stable_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = ex_stable.mk
...
MODELLIB                  = ex_stablelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ex_stable_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\experiment_5S\group02\stable\ex_stable_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\experiment_5S\group02\stable
