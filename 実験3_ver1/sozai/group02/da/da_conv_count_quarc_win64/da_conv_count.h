 ...
 * C source code generated on : Fri Sep 20 11:22:50 2024
 *
 ...
 */
#ifndef RTW_HEADER_da_conv_count_h_
#define RTW_HEADER_da_conv_count_h_
#ifndef da_conv_count_COMMON_INCLUDES_
# define da_conv_count_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* da_conv_count_COMMON_INCLUDES_ */

#include "da_conv_count_types.h"
...
typedef struct {
  ...
  real_T Gaincounttometer;             /* '<Root>/Gain (count to meter)' */
...
struct P_da_conv_count_T_ {
  ...
  real_T Gainpolarity_Gain;            /* Expression: 1
                                        ...
                                        */
  real_T Gaincounttometer_Gain;        /* Expression: 0.9/38463
...
struct tag_RTM_da_conv_count_T {
...
extern P_da_conv_count_T da_conv_count_P;

/* Block signals (auto storage) */
extern B_da_conv_count_T da_conv_count_B;

/* Continuous states (auto storage) */
extern X_da_conv_count_T da_conv_count_X;

/* Block states (auto storage) */
extern DW_da_conv_count_T da_conv_count_DW;

/* Model entry point functions */
extern void da_conv_count_initialize(void);
extern void da_conv_count_step(void);
extern void da_conv_count_terminate(void);

/* Real-time Model object */
extern RT_MODEL_da_conv_count_T *const da_conv_count_M;
 ...
 * '<Root>' : 'da_conv_count'
 */
#endif                                 /* RTW_HEADER_da_conv_count_h_ */
