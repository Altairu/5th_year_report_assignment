 ...
 */
#ifndef RTW_HEADER_ex_cart_ident_h_
#define RTW_HEADER_ex_cart_ident_h_
#ifndef ex_cart_ident_COMMON_INCLUDES_
# define ex_cart_ident_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_cart_ident_COMMON_INCLUDES_ */

#include "ex_cart_ident_types.h"
...
struct P_ex_cart_ident_T_ {
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: zc
                                        * Referenced by: '<Root>/Step'
                                        */
...
struct tag_RTM_ex_cart_ident_T {
...
extern P_ex_cart_ident_T ex_cart_ident_P;

/* Block signals (auto storage) */
extern B_ex_cart_ident_T ex_cart_ident_B;

/* Block states (auto storage) */
extern DW_ex_cart_ident_T ex_cart_ident_DW;

/* Model entry point functions */
extern void ex_cart_ident_initialize(void);
extern void ex_cart_ident_step(void);
extern void ex_cart_ident_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ex_cart_ident_T *const ex_cart_ident_M;
 ...
 *
 * '<Root>' : 'ex_cart_ident'
 * '<S1>'   : 'ex_cart_ident/Subsystem (Inverted Pendulum)'
 */
#endif                                 /* RTW_HEADER_ex_cart_ident_h_ */
