 ...
 */
#ifndef RTW_HEADER_pend_count2_h_
#define RTW_HEADER_pend_count2_h_
#ifndef pend_count2_COMMON_INCLUDES_
# define pend_count2_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* pend_count2_COMMON_INCLUDES_ */

#include "pend_count2_types.h"
...
typedef struct {
  ...
  real_T Gaincounttorad;               /* '<Root>/Gain (count to rad)' */
...
extern P_pend_count2_T pend_count2_P;

/* Block signals (auto storage) */
extern B_pend_count2_T pend_count2_B;

/* Block states (auto storage) */
extern DW_pend_count2_T pend_count2_DW;

/* Model entry point functions */
extern void pend_count2_initialize(void);
extern void pend_count2_step(void);
extern void pend_count2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_pend_count2_T *const pend_count2_M;
 ...
 * '<Root>' : 'pend_count2'
 */
#endif                                 /* RTW_HEADER_pend_count2_h_ */
