...
MODEL                = ex_ident
MODULES              = ex_ident_data.c ex_ident_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = ex_ident.mk
...
MODELLIB                  = ex_identlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ex_ident_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\student_5S\group03\ident\ex_ident_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\student_5S\group03\ident
